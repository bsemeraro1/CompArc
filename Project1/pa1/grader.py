...
assignment = autograde.MultiProject(
    autograde.StringTests.Project('rot13', weight=0.6),
    ArgFileTests.Project('sorta'),
    autograde.Project('sudoku',
        autograde.FileTests(id='1', weight=1.5),
        autograde.FileTests(id='2', weight=1.5)
    ),
